...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Exercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<bool>("CardAlmostExpired");

                    b.Property<bool>("CardExpired");

                    b.Property<bool>("IncomingTraining");

                    b.Property<bool>("ListToReserveList");

                    b.Property<bool>("ReserveListSignOutConfirmed");

                    b.Property<bool>("ReserveListSignUpConfirmed");

                    b.Property<bool>("ReserveListToList");

                    b.Property<bool>("SignOutConfirmed");

                    b.Property<bool>("SignUpConfirmed");

                    b.Property<bool>("TrainingDeleted");
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Training", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.UserCalendarTraining", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UserCalendarTrainings");
                });
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.UserTraining", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Chat", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TrainingPlanner.Data.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Exercise", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.UserTraining", "UserTraining")
                        .WithMany("Exercises")
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Message", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.Chat", "Chat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Notification", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.ApplicationUser", "User")
                        ...
                        .HasForeignKey("TrainingPlanner.Data.Entities.Notification", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.Reservation", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.Training", "Training")
            ...
            modelBuilder.Entity("TrainingPlanner.Data.Entities.UserCalendarTraining", b =>
                {
                    b.HasOne("TrainingPlanner.Data.Entities.UserTraining", "UserTraining")
                        .WithMany("UserCalendarTrainings")
                        .HasForeignKey("UserTrainingId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
